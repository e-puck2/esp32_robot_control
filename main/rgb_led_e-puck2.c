...
void set_all_green(uint8_t value) {
	rgb_value[0][0]=0;
	rgb_value[0][1]=value;
	rgb_value[0][2]=0;
	rgb_value[1][0]=0;
...
void set_all_red(uint8_t value) {
	rgb_value[0][0]=value;
	rgb_value[0][1]=0;
	rgb_value[0][2]=0;
	rgb_value[1][0]=value;
...
void set_all_blue(uint8_t value) {
	rgb_value[0][0]=0;
	rgb_value[0][1]=0;
	rgb_value[0][2]=value;
	rgb_value[1][0]=0;
...
void set_all_yellow(uint8_t value) {
	rgb_value[0][0]=value;
	rgb_value[0][1]=value;
	rgb_value[0][2]=0;
	rgb_value[1][0]=value;
...
void set_all_white(uint8_t value) {
	rgb_value[0][0]=value;
	rgb_value[0][1]=value;
	rgb_value[0][2]=value;
	rgb_value[1][0]=value;
...
void rgb_task(void *pvParameter) {
	...
	while(1) {
		event_bits = xEventGroupWaitBits(rgb_event_group, UPDATE_ALL_RGB_LEDS | UPDATE_LED2 | UPDATE_LED4 | UPDATE_LED6 | UPDATE_LED8, true, false, portMAX_DELAY);
